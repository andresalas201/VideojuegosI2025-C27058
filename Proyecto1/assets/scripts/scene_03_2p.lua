scene = {
    ...
    sprites = {
        ...
        {
            assetId = "Bg_01",
            filePath = "assets/images/Background3.png"
        },
        {
            assetId = "player_ship",
        ...
        {
            assetId = "cruiser",
            filePath = "assets/images/Cruiser3.png"
        },
        {
            assetId = "enemy_alan",
            filePath = "assets/images/Improved_Alan3.png"
        },
        {
            assetId = "missile",
            filePath = "assets/images/Missiles3.png"
        },
        {
            assetId = "gormoth",
            filePath = "assets/images/GormothTwin.png"
        }
    ...
    enemies = {
        ...
        -- Jefe
        {
            ...
            attack = {
                ...
                frame_speed_rate = 1,
                is_loop = true;
                attack_path = "assets/scripts/basic_enemy_follow.lua"
            },
            radius = 16,
            width = 64,
            height = 64,
            update_path = "assets/scripts/final_boss_moveset.lua",
            health = 100,
            damage = 1,
            vel_x = -100,
            vel_y = 0,
