...
function on_collision(other)
    ...
    if other_tag == "barrier" then
        if left_collision(this, other) then
            print("El lado izquierdo de "..this_tag.." colisiona con el lado derecho de "..other_tag)
        ...
        if right_collision(this, other) then
            print("El lado derecho de "..this_tag.." colisiona con el lado izquierdo de "..other_tag)
